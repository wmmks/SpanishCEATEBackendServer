...
public class ConstantField {
    static public String userAndArticleID = "id";
    static public String userAndArticleSystemType = "system_type";
    static public String databaseStringType = "VARCHAR";
    static public String databaseIntType = "INT";
    static public String WORD_TEXT = "text";
    static public String WORD_POS = "pos";
    static public String NEXT_WORD_POS = "next_pos";
    static public String ARTICLE_ID = "article_id";
    static public String SENTENCE_ID = "sentence_id";
